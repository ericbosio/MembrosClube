...
public class SQLiteClass extends SQLiteOpenHelper {
    ...
    //Add Employee Data
    public void addEmployee(MembrosClass membrosClass){
    ...
    public List<MembrosClass> getEmployeeList(){
        String sql = "select * from " + TABLE_NAME;
        sqLiteDatabase = this.getReadableDatabase();
        List<MembrosClass> storeEmployee = new ArrayList<>();
        ...
        if (cursor.moveToFirst()){
            do {
                ...
                storeEmployee.add(new MembrosClass(id,name,email));
    ...
    public void updateEmployee(MembrosClass membrosClass){
        ContentValues contentValues = new ContentValues();
        contentValues.put(SQLiteClass.NAME, membrosClass.getName());
        contentValues.put(SQLiteClass.EMAIL, membrosClass.getEmail());
        sqLiteDatabase = this.getWritableDatabase();
